    ...
    <main>
        ...
        <div class="container curso_detalhes">
            <div class="row">
                ...
                <div class="col-12">
                    <a href="index.php?language=fr" class="btn btn-primary" style="margin-top: 30px">Retourner à la page d'accueil</a>
                    <h2><?php echo $nome; ?></h2>
                    <p><?php echo $sobre; ?></p>
                </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                  <td><a href="lesson_fr.php?codigo=<?php echo $linha['codigo'] ?>&language=fr"><?php echo $indice ?> - <?php echo $linha["nome"]; ?></a></td>
                                </tr>
