...
<?php
    ...
    if(isset($_GET["perguntaRealizada"])){
        echo "<script>alert('Your question has been sent to our teacher, we will respond shortly.')</script>";
    }
...
?>
    ...
    <main>
        ...
        <div class="container curso_detalhes">
            <div class="row">
                ...
                <div class="col-12">
                    <button class="btn btn-primary" style="margin-top: 30px" onclick="history.back()">Return to the class</button>
                    <h2><?php echo $nome; ?></h2>
                    <p><?php echo $sobre; ?></p>
                </div>
                ...
                <div class="col-12 materiais">
                    ...
                    <?php
                        if($materiais == ""){
                            echo "<p>There are no extra materials.</p>";
                        }else{
                            echo "<p>$texto_materiais</p>";
                            echo "<a href='../materials/$materiais'>Downolad the material</a>";
                        }
                    ?>
                </div>
                ...
                <div class="col-12 questions">
                        ...
                        <?php
                            ...
                            while($linha = $resultado->fetch_assoc()){
                                if($indice % 2 == 0){
                                    ...
                                    if($indice % 2 == 0){
                                        echo "<p>Author: ".$nome_aluno." | <span style='color:red'>".$linha['data_hora']."<span></p>";
                                    }else{
                                        echo "<p>Author: Teacher | <span style='color:red'>".$linha['data_hora']."<span></p>";
                                    }

                                    if($linha["arquivo"] != ""){
                                        echo "<a href='../question_files/$linha[arquivo]' target='_blank' class='btn btn-secondary' style='margin-top:10px;'>Download file</a>";
                                    }
                                echo "</li>";
                    ...
                    <?php
                        if($pergunta_pendente){
                            echo "";
                            echo "<p>We are waiting for your teacher to respond.</p>";
                        }else{
                    ?>
                        <form action="send_doubt.php" method="post" enctype="multipart/form-data">
                            
                            <!--
                            <textarea name="mensagem" placeholder="Do you have doubts? Write your message here." class="form-control" style="margin-bottom:10px"></textarea>
                            -->
                            ...
                            <textarea id="mensagem_duvida" maxlengt="250" name="mensagem" class="form-control" style="height:200px;">Do you have doubts? Write your message here.</textarea>
                            </div>
                ...
                <div class="col-12 questions" style="margin-top:50px;">
                    <h3>Comments about the class</h3>
                    ...
                    <form action="send_comment.php" method="post">
                        ...
                        <textarea maxlengt="250" onkeyup="obterTexto()" name="mensagem" class="form-control" style="height:200px;">Comment about the class.</textarea>
                        </div>
    ...
    <script>
        ...
        document.getElementById("link_atual2").value = window.location.href;
    </script>
